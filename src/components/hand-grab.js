  ...
  init: function () {
    ...
    this.el.addEventListener('grab-end', () => {
      ...
      if (this.el.body) {
        ...
        // Appliquer la vélocité avec un multiplicateur
        const throwMultiplier = 1.5; // Ajusté pour être naturel
        ...
        // PETITE ASTUCE: 
        // Décaler légèrement l'objet vers le haut pour éviter qu'il ne soit clipé DANS la table
        // ce qui le ferait passer à travers
        this.el.body.position.y += 0.05;

        console.log(`🚀 Lancé/Lâché! Vélocité: (${vx.toFixed(2)}, ${vy.toFixed(2)}, ${vz.toFixed(2)})`);
      }
    });
  },
